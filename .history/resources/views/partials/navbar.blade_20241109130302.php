             ...
             <div class="row align-items-center">
                 <div class="col-xl-12">
                     <nav class="navbar navbar-expand-lg">
                        <a class="navbar-brand" href="index.blade.php" style="display: inline-block; width: 200px; height: 200px;">
                            <img id="logo" src="{{ asset('assets/images/logo_utm_full.png') }}" alt="Logo" style="width: 50px; height: 50px;">
                        </a>                        
